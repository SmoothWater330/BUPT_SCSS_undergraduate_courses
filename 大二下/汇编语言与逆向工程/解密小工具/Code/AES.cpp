...
int aesDecrypt(const unsigned char* key, unsigned int keyLen, const unsigned char* ct, unsigned char* pt, unsigned int len) {
    ...
    const unsigned int* rk = aesKey.dK;
...
int AES(unsigned char key[17], unsigned char ct[]) {
    ...
    //unsigned char ct[32] = { 0xfc,0xad,0x71,0x5b,0xd7,0x3b,0x5c,0xb0,0x48,0x8f,0x84,0x0f,0x3b,0xad,0x78,0x89,0xd0,0xe7,0x09,0xd0,0xff,0xd3,0x8c,0x6d,0xfe,0xc5,0x5c,0xcb,0x9f,0x47,0x5b,0x01 };
    int length = strlen((const char*)ct);
    unsigned char plain[100] = { 0 };

    aesDecrypt(key, 16, ct, plain, length);
